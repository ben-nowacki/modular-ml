...
class BackendNotSupportedError(ModularMLError):
    ...
    def __init__(self, backend: Backend, method: str | None = None, message: str | None = None):
        if message is None:
            if method is None:
...
class OptimizerNotSetError(OptimizerError):
    ...
    def __init__(self, method: str | None = None, message: str | None = None):
        if message is None:
            message = "Missing Optimizer." if method is None else f"Missing Optimizer in method `{method}`."
        super().__init__(message)
...
class LossNotSetError(LossError):
    ...
    def __init__(self, method: str | None = None, message: str | None = None):
        if message is None:
            message = "Missing AppliedLoss." if method is None else f"Missing AppliedLoss in method `{method}`."
        super().__init__(message)
